    ...
    <section class="hero bg-image" data-image-src="images/img/food1.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                ...
                <h5 class="font-white space-xs">Tìm kiếm mọi món ăn tại mọi nơi
                    bạn muốn</h5>
                <div class="banner-form">
                    <form class="form-inline">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputAmount">Tìm
                                món bạn muốn chọn...</label>
                            <div class="form-group">
                                <input type="text"
                        ...
                        <button onclick="location.href='restaurants.php'"
                            type="button" class="btn theme-btn btn-lg">Search
                            Food</button>
                    </form>
                </div>
                <div class="steps">
