    ...
    <section class="hero bg-image" data-image-src="images/img/food1.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                ...
                <h5 class="font-white space-xs">Tìm kiếm mọi món ăn tại mọi nơi bạn muốn</h5>
                <div class="banner-form">
                    <form class="form-inline">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputAmount">Tìm món bạn muốn chọn...</label>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" id="exampleInputAmount"
                                    placeholder="Tìm món bạn muốn chọn....">
                            </div>
                        </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>Chúng tôi luôn sao kê các danh sách món ăn từng mọi nơi</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Đặt món mà bạn muốn và sau đó thực hiện thao tác shipping</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row top-footer">
                <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                    <a href="#"> <img src="images/koji.png" alt="Footer logo" class="img-footer"> </a> <span>Order
