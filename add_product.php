...
<form method="post">
        ...
        <div class="row">
            ...
            <div class="lblinput">
                <textarea  name="txtquantity" cols="21" rows="10" value="<?php echo isset($_POST["txtquantity"]) ? $_POST["txtquantity"] : "" ; ?> "> </textarea>
            </div>
        </div>
        <div class="row">
            <div class="lbltitle">
            ...
            <div class="lblinput">
                <textarea  name="txtprice" cols="21" rows="10" value="<?php echo isset($_POST["txtprice"]) ? $_POST["txtprice"] : "" ; ?> "> </textarea>
            </div>
        </div>
        <div class="row">
            <div class="lbltitle">
        ...
        <div class="row">
            ...
            <div class="lblinput">
                <textarea  name="txtpic" cols="21" rows="10" value="<?php echo isset($_POST["txtpic"]) ? $_POST["txtpic"] : "" ; ?> "> </textarea>
            </div>
        </div>
        <div class="row">
            <div class="submid">
